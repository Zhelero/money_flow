...
from exceptions import NotEnoughMoneyError, AccountNotFoundError, ExpenseNotFoundError


def test_spend_success(acc_service, exp_service):
...
def test_spend_not_enough_money(acc_service, exp_service):
...
def test_spend_account_not_found(exp_service):
    with pytest.raises(AccountNotFoundError):
        exp_service.spend(50, "Cash", "Food")

def test_edit_success(acc_service, exp_service):
    acc_service.create_account("Cash", 100)
    exp_service.spend(50, "Cash", "Food")
...
def test_edit_increase_amount_not_enough_money(acc_service, exp_service):
...
def test_edit_change_account_success(acc_service, exp_service):
...
def test_edit_change_account_not_enough_money(acc_service, exp_service):
    acc_service.create_account("A", 100)
...
def test_edit_not_found(exp_service):
    with pytest.raises(ExpenseNotFoundError):
        exp_service.edit(50, money_source="A")

def test_delete_success(acc_service, exp_service):
    acc_service.create_account("Cash", 100)
    exp_service.spend(50, "Cash", "Food")
...
def test_delete_unsuccessful(acc_service, exp_service):
    acc_service.create_account("Cash", 100)
    exp_service.spend(50, "Cash", "Food")
...
def test_total(acc_service, exp_service):
    acc_service.create_account("Cash", 100)
    exp_service.spend(50, "Cash", "Food")

    assert exp_service.total() == 50

def test_total_category(acc_service, exp_service):
    acc_service.create_account("Cash", 100)
    exp_service.spend(50, "Cash", "Food")
